...
class MockDataService {
  static final List<Property> properties = [
    Property(id: 'p1', address: '123 Fake St, Springfield', lat: 39.7817, lng: -89.6501, averageRating: 1.5),
    Property(id: 'p2', address: '456 Elm Ave, Springfield', lat: 39.7900, lng: -89.6600, averageRating: 4.0),
    Property(id: 'p3', address: '789 Oak Ln, Springfield', lat: 39.7700, lng: -89.6400, averageRating: 2.0),
  ];
  ...
  static Future<List<Review>> getFeed() async {
